...
namespace AutofacGodotDi
{
    ...
    public class InjectSourceGenerator : ISourceGenerator
    {
        ...
        public void Execute(GeneratorExecutionContext context)
        {
            ...
            registrarBuilder.AppendLine("    [System.Runtime.CompilerServices.ModuleInitializer]");
            registrarBuilder.AppendLine("    public static void SelfRegister()");
            registrarBuilder.AppendLine("    {");
            registrarBuilder.AppendLine("        AutofacGodotDi.StaticDependencyInjector.SetRegisterBindingsAction(RegisterBindings);");
            registrarBuilder.AppendLine("    }");
